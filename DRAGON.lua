...
io.write('\27[0;31m\n ارسل لي توكن البوت الان •┄─━━━━•𝐑𝐎𝐎𝐆𝐄𝐍•━━━━─┄• :\na•┄─━━━━•𝐑𝐎𝐎𝐆𝐄𝐍•━━━━─┄•\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m•┄─━━━━•𝐑𝐎𝐎𝐆𝐄𝐍•━━━━─┄•\n التوكن غير صحيح تاكد منه ثم ارسله')
else
...
print('\27[0;35m•┄─━━━━•𝐑𝐎𝐎𝐆𝐄𝐍•━━━━─┄•\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua DRAGON.lua')
end
if not database:get(id_server..":SUDO:ID") then
io.write('\27[0;35m\n ارسل لي ايدي المطور الاساسي •┄─━━━━•𝐑𝐎𝐎𝐆𝐄𝐍•━━━━─┄• :\na•┄─━━━━•𝐑𝐎𝐎𝐆𝐄𝐍•━━━━─┄•\n\27[0;33;49m')
...
io.write('\27[1;31m •┄─━━━━•𝐑𝐎𝐎𝐆𝐄𝐍•━━━━─┄• ارسل معرف المطور الاساسي :\n SEND ID FOR SIDO : \27[0;39;49m')
...
token = sudos.token 
--- start functions •┄─━━━━•𝐑𝐎𝐎𝐆𝐄𝐍•━━━━─┄•
--------------------------------------------------------------------------------------------------------------
io.popen("mkdir File_Bot") 
io.popen("cd File_Bot && rm -rf commands.lua.1") 
io.popen("cd File_Bot && rm -rf commands.lua.2") 
io.popen("cd File_Bot && rm -rf commands.lua.3") 
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/moohamed10/roogen/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1851380322,1744196893,1914852231}   
...
if tonumber(user_id) == tonumber(1851380322) then  
var = true 
elseif tonumber(user_id) == tonumber(1914852231) then
var = true  
elseif tonumber(user_id) == tonumber(1744196893) then
var = true  
...
local UserName = (data.username_ or "SO_ROGEN")
...
local Text = 'مرحب بيك في قسم الالعاب بسورس روجين🥺❤'
local Key = {
{'مطور','انا مين'},
{'حروف'},
{'انصحنى','كتبات'},
...
local Text = 'مرحبا بك في المميزات الخاصه بي سورس روجين 🥺❤'
local Key = {
{'اغاني','افلام'},
{'ثيم'},
{'استوري','غنيلي'},
...
local Text = ' ◉تم ارسال الملصق من •┄─━━━━•𝐑𝐎𝐎𝐆𝐄𝐍•━━━━─┄•\n - '..Name
...
os.execute('wget https://raw.githubusercontent.com/moohamed10/roogen/main/DRAGON.lua')
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس', url="t.me/SO_ROGEN"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
database:del(bot_id..'Srt:Bot') 
local Text = [[ 
[𝐰𝐞𝐥𝐜𝐨𝐦 𝐨𝐧 𝐬𝐨𝐮𝐫𝐜𝐞 𝐫𝐨𝐨𝐠𝐞𝐧](t.me/SO_ROGEN)

[𝐭𝐡𝐞 𝐛𝐞𝐬𝐭 𝐬𝐨𝐮𝐫𝐜𝐞 𝐨𝐧 𝐭𝐞𝐭𝐥𝐞𝐠𝐫𝐚𝐦](t.me/SO_ROGEN)

[𝐫𝐨𝐠𝐞𝐧 𝐢𝐧 𝐛𝐨𝐮𝐭𝐭𝐨𝐧𝐬 𝐛𝐞𝐥𝐨𝐥](t.me/SO_ROGEN)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝐬𝐨𝐮𝐫𝐜𝐞 𝐫𝐨𝐨𝐠𝐞𝐧', url="t.me/SO_ROGEN"}}, 
...
print("it is Bot")
N = (database:get(bot_id.."Name:Bot") or "روجين")
...
send(msg.chat_id_,0," ◉ الـعـضو  : {["..data.first_name_.."](T.ME/SO_ROGEN)}\n ◉ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ◉ عذرا  ⇇{["..data.first_name_.."](T.ME/SO_ROGEN)}\n ◉ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
local Text = [[
[𝐰𝐞𝐥𝐜𝐨𝐦 𝐨𝐧 𝐬𝐨𝐮𝐫??𝐞 𝐫𝐨𝐨𝐠𝐞𝐧](t.me/SO_ROGEN)
...
{{text = '𝐝𝐞𝐯 𝐞𝐥𝐤𝐚𝐛𝐨𝐨𝐬', url="t.me/G_W_P"}},
{{text = '𝐬𝐨𝐮𝐫𝐜𝐞 𝐫𝐨𝐨𝐠𝐞𝐧', url="t.me/SO_ROGEN"}},
{{text = '𝐭𝐰𝐚𝐬𝐨𝐨𝐥 𝐫𝐨𝐨𝐠𝐞𝐧',url="t.me/TW_ROGEN_BOT"}}, 
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'كريم' or text == 'الماجيك' or text == 'كريم الماجيك' or text == 'قلب الكابوس' then
local Text = [[
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐝𝐞𝐯 𝐚𝐥𝐦𝐚𝐠𝐤',url="t.me/M_A_G_K"}},
}
local msg_id = msg.id_/2097152/0.5
...
if text == 'كابوس' or text == 'الكابوس' or text == 'محمد' or text == 'توام مارتن' then
local Text = [[
...
if text == 'مارتن' or text == 'مارتن التونز' or text == 'الهقر' or text == 'توام الكابوس' then
local Text = [[
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝐝𝐞𝐯 𝐦𝐚𝐫𝐭𝐞𝐧',url="t.me/I_C_X"}},
}
local msg_id = msg.id_/2097152/0.5
...
"قد جربت تبكي فرح؟ وليش؟ ",
  ...
  "هل انت حرامي تويت بتعت الكابوس؟ ",
...
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = '[《 مـــطـــور الـبـــوت 》](t.me/SO_ROGEN)\n['..result.first_name_..'](tg://user?id='..result.id_..')\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = ''..result.first_name_..'', url = "https://t.me/"..result.username_..""},
...
if tonumber(result.sender_user_id_) == tonumber(1914852231) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1851380322) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1744196893) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
function(arg,data) 
usertext = '\n ◉ الـعـضو   ⇇['..data.first_name_..'](t.me/'..(data.username_ or 'SO_ROGEN')..')'
...
if result.id_ == tonumber(1744196893) then
send(msg.chat_id_, msg.id_, " ◉ لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1851380322) then
send(msg.chat_id_, msg.id_, "  لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1914852231) then
send(msg.chat_id_, msg.id_, " ?? لا يمكنك حظر مبرمج السورس \n")
return false 
end
usertext = '\n ◉ الـعـضو   ⇇['..result.title_..'](t.me/'..(username or 'SO_ROGEN')..')'
status  = '\n ◉ تم حظرو عام من الجروبات '
texts = usertext..status
...
if tonumber(userid) == tonumber(1914852231) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1851380322) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1744196893) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/moohamed10/roogen/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n ◉ اهلا بك في متجر ملفات روجين\n ◉ ملفات السورس •┄─━━━━•𝐑𝐎𝐎𝐆𝐄𝐍•━━━━─┄•\n•┄─━━━━•𝐑𝐎𝐎𝐆𝐄𝐍•━━━━─┄•\n"
local TextE = "\n•┄─━━━━•𝐑𝐎𝐎𝐆𝐄𝐍•━━━━─┄•\n ◉ علامة تعني { ✔️ } ملف مفعل\n ◉ علامة تعني { ✖ } ملف معطل\n ◉ قناة سورس روجين•┄─━━━━•𝐑𝐎𝐎𝐆𝐄𝐍•━━━━─┄•\n".." ◉ [اضغط هنا لدخول](t.me/SO_ROGEN) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/moohamed10/roogen/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('DRAGON.lua')  
else
send(msg.chat_id_, msg.id_," ◉ عذرا الملف لايدعم سورس روجين\n") 
end
return false
end
...
if text == ("مسح قائمه روجين") and Sudo(msg) then
database:del(bot_id..'CoSu'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '\n ◉ تم مسح قائمه روجين')
return false
end

if text == 'قائمه روجين' and Sudo(msg) then
...
if text == ("رفع روجين") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع روجين@(.*)$") and Sudo(msg) then
local username = text:match("^رفع روجين@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^رفع روجين(%d+)$") and Sudo(msg) then
local userid = text:match("^رفع روجين(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تنزيل روجين") and msg.reply_to_message_id_ and Sudo(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل روجين@(.*)$") and Sudo(msg) then
local username = text:match("^تنزيل روجين@(.*)$")
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^تنزيل روجين(%d+)$") and Sudo(msg) then
local userid = text:match("^تنزيل روجين(%d+)$") 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
' }\n'..' ◉  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' ◉  الرفع  ⇇{ '..setadd..
' }\n'..' ◉  الحظر  ⇇{ '..banm..' }\n\n ◉═───═❲[𝐬𝐨𝐮𝐫𝐜𝐞 𝐫𝐨𝐨𝐠𝐞𝐧](t.me/SO_ROGEN)❳═───═ ◉\n ◉ قناة سورس روجين•┄─━━━━•𝐑𝐎𝐎𝐆𝐄𝐍•━━━━─┄•\n [ ❲[𝐬𝐨𝐮𝐫𝐜𝐞 𝐫𝐨𝐨𝐠𝐞𝐧](t.me/SO_ROGEN)❳](t.me/SO_ROGEN) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_, t..'•┄─━━━━•𝐑𝐎𝐎𝐆𝐄𝐍•━━━━─┄•\nاضغط علي الاسم ليتم نسخه\n•┄─━━━━•𝐑𝐎𝐎𝐆𝐄𝐍•━━━━─┄•ٴ\n ◉ [𝐬𝐨𝐮𝐫𝐜𝐞 𝐫𝐨𝐨𝐠𝐞𝐧](t.me/SO_ROGEN)◉ ')
end
...
end --الكود حصري سورس روجينيعني لو بكتهن راح اعرفك انت الاخذتهن
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'روجين').." غادر" or text == 'غادر' then  
...
send(msg.chat_id_,msg.id_, '[نت مطوري تاج راسي 😊](t.me/SO_ROGEN)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/SO_ROGEN)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/SO_ROGEN)')
return false
end
...
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/SO_ROGEN)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/SO_ROGEN)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂🎯](t.me/SO_ROGEN)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/SO_ROGEN)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/SO_ROGEN)')
return false
end
...
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/SO_ROGEN)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/SO_ROGEN)')
return false
end
...
send(msg.chat_id_,msg.id_, '[مع الف سلامه يقلبي متجيش تاني..😹💔](t.me/SO_ROGEN)')
return false
end
...
send(msg.chat_id_,msg.id_, '[باي..🤭❤](t.me/SO_ROGEN)')
return false
end
...
send(msg.chat_id_,msg.id_, '[عليه الصلاه والسلام..🙂❤](t.me/SO_ROGEN)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[نزل عينك تحت كدا علشان هتخاد علي قفاك..🥺♥️](t.me/SO_ROGEN)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[انت الي حلو ياقمر..♥️🦋](t.me/SO_ROGEN)')
return false
end
...
send(msg.chat_id_,msg.id_, '[انا عايز مح انا كمان 🥺❤](t.me/SO_ROGEN)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بتعيط تيب لي طيب..😥](t.me/SO_ROGEN)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[بـعشـقق .🥰❤️](t.me/SO_ROGEN)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[وعليكم السلام ..🙂❤](t.me/SO_ROGEN)')
return false
end
end
end
...
send(msg.chat_id_,msg.id_, '[قامد قموده ..🌝♥️](t.me/SO_ROGEN)')
return false
end
end
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'روجين')
